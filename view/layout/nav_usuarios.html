        ...
        <nav class="nav">
            <ul class="nav-list">
                ...
                <div class="nav-buttons">
                    <li>
                        <a href="../FRESAS_ARTURO/model/perfil.php">Perfil <i class="bi bi-person-circle"></i></a>
                    </li>
                    <li>
                        <a href="../Fresas_Arturo/model/login_usuarios.php">Salir<i class="bi bi-box-arrow-in-right"></i></a>
                    </li>
                </div>
            </ul>
        </nav>
    </header>
    <script src="../../../FRESAS_ARTURO/resource/js/layout/nav.js"></script>
</body>
