...
<head>
    ...
    <link rel="stylesheet" href="../../../resource/css/footer-usuarios.css">
</head>
<body>
<footer class="footer">
    <div class="footer-info">
        ...
        <p><b>Teléfono:</b> +57 3118226066</p>
    ...
    <div class="footer-ingreso">
        ...
        <ul>
            <li><a href="../../../model/login_usuarios.php">Ingresar</a></li>
            <li><a href="../../../model/login_usuarios.php?click">Registro</a></li>
        </ul>
    </div>
