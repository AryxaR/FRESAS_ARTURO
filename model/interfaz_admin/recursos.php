...
<div class="breadcrumbs-container">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item dos" aria-current="page">Recurso proveedor</li>
        </ol>
    </nav>
</div>
...
<head>
    ...
    <style>
        ...
        select {
            ...
            margin-bottom: 20px;
            /* Añade un espacio entre el select y el input */
            padding: 10px;
            /* Aumenta el espacio interno del select */
        }
        ...
        input[type="number"] {
            ...
            /* Aumenta el tamaño del texto */
            padding: 10px;
            /* Aumenta el espacio interno del input */
            margin-bottom: 20px;
            /* Añade un espacio entre el input y el botón */
            font-family: 'Poppins', sans-serif;
        }
...
<body>
    <div class="TITULO">RECURSO DEL PROVEEDOR</div>
